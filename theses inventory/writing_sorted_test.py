...
def formatting(file_name_list, worksheet_list, workbook_list, title_list, title_width):
    ...
    for i in range(len(file_name_list)):
        ...
        if i == 1:  # if its the remove spreadsheet
            for j in range(len(title_list) - 1):  # not including the SDG groups
...
file_paths = ['keep_list_test.txt', 'del_list_test.txt', 'save_list_test.txt']  # list of file names
wb_names = ['Test - Keep.xlsx', 'Test - Deleted.xlsx', 'Test - Saved.xlsx']  # list of spreadsheet names
