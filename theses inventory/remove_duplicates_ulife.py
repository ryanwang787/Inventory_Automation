...
sheet_path = 'ULife - Keywords.xlsx'  # name of SORTED spreadsheet to be highlighted
wb_name = 'ULife - Dups.xlsx'  # new workbook name
# headings
titles = ['Club Name', 'Club Description', 'URL', 'Primary Contact', 'Club Email', 'Club Website', 'Campus Association',
          'Areas of Interest', 'Twitter', 'Facebook', 'Instagram', 'Keywords']  # list of column titles
col_width = [40, 160, 40, 40, 40, 40, 40, 120, 40, 40, 40, 40]  # list of column widths
