...
def read_write(loc, wb_name, title_list, title_width):
    """
    ...
    :param wb_name: File name of the new spreadsheet
...
sheet_path = 'Test - SRU Keywords.xlsx'  # name of SORTED spreadsheet to be highlighted
wb_name = 'Test - SRU Removed Duplicates.xlsx'  # new workbook name
# headings
titles = ['Group Name', 'About', 'Keyword(s)']
# width of headings
col_width = [43, 150, 18]
