...
sheet_path = 'Test - Masters Keywords.xlsx'  # spreadsheet we are sorting through
...
list_list = ['keep_list_test.txt', 'del_list_test.txt', 'save_list_test.txt', 'checked_rows_test.txt']  # list of lists
