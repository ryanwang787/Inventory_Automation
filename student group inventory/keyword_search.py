...
def search(list, sheet, worksheet, keyword, SDGs):
    ...
    for i in list:
        ...
        for j in range(len(keyword)):
            ...
            if keyword[j] in str(i[0]).lower() or keyword[j] in str(i[1]).lower() or keyword[j] in str(i[6]).lower():
...
sheet_path = 'Student group inv master spreadsheet.xlsx'  # name of full spreadsheet
wb_name = 'Test - student group inv.xlsx'  # new workbook
# name
...
col_width = [40, 160, 40, 40, 40, 10, 120, 40, 40, 40]  # list of column widths
