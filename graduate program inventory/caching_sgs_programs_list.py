...
def wipe(files):
    ...
    :return: None
    """
    print("Would you like to wipe the Programs List Data? y/n")
...
file_list = ['SGS_programs_list.txt', 'SGS_programs_list_cache.txt']  # init file list
...
'''for i in range(45): # this is for all the search pages. Don't run this until we contact ULife admin
    page_links.append('https://www.ulife.utoronto.ca/organizations/list/page/' + str(i + 1) + '/type/all')'''
'''
for i in range(0, 1):  # 0 to 1 is for the first search page
...
'''
page_url = 'https://www.sgs.utoronto.ca/programs/'
pages.append(get_html(page_url, url_cache_contents, file_list[1], headers))
