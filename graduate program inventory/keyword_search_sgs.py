...
def search(list, sheet, worksheet, keyword, SDGs):
    ...
    for i in list:
        ...
        for j in range(len(keyword)):
            ...
            if keyword[j] in str(i[0]).lower() or keyword[j] in str(i[8]).lower():
                write = True
...
sheet_path = "sgs programs.xlsx"  # name of full spreadsheet
wb_name = 'sgs programs - keywords.xlsx'  # new workbook name
