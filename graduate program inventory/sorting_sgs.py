...
def readmore(row):
    ...
    :return: None
    """
    print("Program Description: ", row[8])  # displaying abstract
    print("Graduate Unit: ", row[1])  # displaying subjects
    print("Degree(s): ", row[7])
...
sheet_path = 'sgs programs - removed dups.xlsx'  # spreadsheet we are sorting through
